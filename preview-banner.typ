...
#set text(size: 7mm, font: "DejaVu Sans Mono")
#set page(width: 210mm, height: 90mm, fill: none, margin: 0mm)
#set align(horizon + center)

#box(fill: flavors.mocha.colors.mantle.rgb, width: 100%, height: 100%, radius: 1em)[
  = YapTyp
